            ...
            <div class="modal-body row">
                ...
                <div class="card-body" id="subject-panel">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="#curriculum_view" role="tab" aria-controls="profile" aria-selected="false">VIEW CURRICULUM</a>
                        </li>
                    ...
                    <div class="tab-content" id="myTabContent">
                            ...
                            <div class="row">
                                <div class="col-md-6" style="text-align:center; padding:10px">
                                    <div class="form-group position-relative has-icon-right">
                                        <input type="text" class="form-control" id="open_search" placeholder="Search Subject (Course Code, Course Title, Schedule Code)">
                                ...
                                <div class="col-md-12" style="padding:10px"">
                                    <table class=" mdl-data-table" id="openTable" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>Sched Code</th>
                                            <th>Subject Code</th>
                        ...
                        <div class="tab-pane fade" id="curriculum_view" style="padding-top:1%" role="tabpanel" aria-labelledby="profile-tab">
