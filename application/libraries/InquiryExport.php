...
class inquiryexport extends Student
{
   ...
   public function __construct($parameters = array())
   {
      ...
      $this->inputFileName = './assets/export_template/InquiryTemplate.xlsx';
   ...
   private function SpreadsheetHeader()
   {
      ...
      $drawing->setPath('assets/export_template/sdcalogo.png');
      ...
      $drawing->setName('Paid');
      $drawing->setDescription('Paid');
      $drawing->setPath('assets/export_template/thumbnail.png');
   ...
   private function SpreadsheetWriter()
   {
      ...
      $writer->writeAllSheets();
      header('Content-Disposition: attachment;filename="Student_inquiry_' . $this->first_name . '_' . $this->last_name . '.pdf"');
      header('Cache-Control: max-age=0');
      $writer->save('php://output'); // download file 
