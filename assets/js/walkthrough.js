...
class OSE_Guide{
    ...
    advising(){
        return [
            {
                intro: 'This is the Advising Tab.'
            },
            {
                element: document.querySelector('#choose_subjects'),
                intro: 'Here is the subject section!',
            },
            {
                element: document.querySelector('.addsubject-button'),
                intro: 'Click this to choose the subject you want to take. NOTE: Only Old students are allowed to choose subject\'s that they want to take.'
            },
            {
                element: document.querySelector('.viewsched-button'),
                intro: 'Click this to view the summary of your schedule.'
            },
            {
