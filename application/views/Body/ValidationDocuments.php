                ...
                <div class="table-responsive col-lg-12">
                    <table class="table table-light mb-0">
                        <thead>
                            <tr>
                                <th>Requirements</th>
                                <th max-width="20%">Add File / <font style="font-weight:100;font-size:11px;">check the checkbox on TBF column if the requirements is to be followed</font></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                        <input required <?php echo $req_count>0?'disabled="true"':''; ?> class="form-control form-control-sm" name="<?php echo $list['id_name'];?>" id="<?php echo $list['id_name'];?>" type="file"><div class="invalid-feedback feedback-<?php echo $list['id_name'];?>"><i class="bx bx-radio-circle"></i>This is required.</div>
                                    </td>
                                <td><input <?php echo $req_count>0?'disabled="true"':''; ?> <?php if($req_count>0){echo $list['status']==""?'checked="true"':''; }?> type="checkbox" class="form-check-input" name="check_<?php echo $list['id_name'];?>" onclick="toBeFollow(`<?php echo $list['id_name'];?>`)"></td>
