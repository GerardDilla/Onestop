...
class sdca_mailer
{
	...
	public function sendHtmlEmail($cp,$from,$from_name,$send_to,$subject,$message,$add_data)
	{
        $config = Array(
			'protocol'  => 'smtp',
			'smtp_host' => 'ssl://smtp.gmail.com',
	...
	public function sendHtmlEmail_NoEcho($cp,$from,$from_name,$send_to,$subject,$message,$add_data)
	{
        $config = Array(
			'protocol'  => 'smtp',
			'smtp_host' => 'ssl://smtp.gmail.com',
