<div class="row">
    ...
    <div class="col-md-4 row">
        ...
        <ul class="paymentbullet">
            ...
            <li><button type="button" class="btn btn-lg btn-primary" onclick="assessment_exporter('<?php echo site_url('temp_api/export_assessmentform') ?>')">SDCA COUNTER</button><br></li>
            <li>
                <hr>
                <h4>Already Paid?</h4>
            </li>
