                                    ...
                                    <div class="table-row row col-md-12">
                                        ...
                                        <div class="col-lg-4 row div-td">
                                            ...
                                            <div class="col-lg-12 col-md-8 col-sm-8">
                                                <input type="file" class="form-control form-control-sm" <?php echo $list['status']=="pending" ? 'disabled="true"' : 'required'; ?> name="<?php echo $list['id_name']; ?>" id="<?php echo $list['id_name']; ?>">
                                        ...
                                        <div class="col-lg-1 row div-td">
                                            ...
                                            ?>
                                            <div class="col-lg-12 col-md-8 col-sm-8"><input <?php echo $list['status'] == "pending" ? 'disabled="true"' : ''; ?>  type="checkbox" class="form-check-input <?php echo $req == 1 ? 'requirement-1' : ''; ?>" name="check_<?php echo $list['id_name']; ?>" onclick="toBeFollow(`<?php echo $list['id_name']; ?>`)"></div>
                                        </div>
                                ...
                                ?>
                                    ...
                                    <div class="table-row row col-md-12" style="display:none;" id="married_certificate_div">
                                        ...
                                        <div class="col-lg-4 row div-td">
                                            <div class="col-lg-12 col-md-4 col-sm-4 min-th"><span><span>Add File / <font style="font-weight:100;font-size:11px;">check the checkbox on TBF column if the requirements is to be followed</font></span></span></div>
                                            <div class="col-lg-12 col-md-8 col-sm-8">
                                                <input type="file" class="form-control form-control-sm" <?php echo $list['status'] == "pending"? 'disabled="true"' : ''; ?> name="<?php echo $list['id_name']; ?>" id="<?php echo $list['id_name']; ?>" >
                                                <div class="invalid-feedback feedback-<?php echo $list['id_name']; ?>"><i class="bx bx-radio-circle"></i>This is required.</div>
                                            </div>
                                        </div>
                                        <div class="col-lg-1 row div-td">
                                            <div class="col-lg-12 col-md-4 col-sm-4 min-th"><span>To Follow</span></div>
                                            <div class="col-lg-12 col-md-8 col-sm-8"><input <?php echo $list['status'] == "to follow"? 'disabled="true"' : ''; ?> checked="true" type="checkbox" class="form-check-input <?php echo $req == 1 ? 'requirement-1' : ''; ?>" name="check_<?php echo $list['id_name']; ?>" onclick="toBeFollow(`<?php echo $list['id_name']; ?>`)"></div>
                                        </div>
                                        <div class="col-lg-2 row div-td div-align-center">
                                            <div class="col-lg-12 col-md-4 col-sm-4 min-th"><span>Status</span></div>
                                            <div class="col-lg-12 col-md-8 col-sm-8"><?php echo $list['status']; ?></div>
