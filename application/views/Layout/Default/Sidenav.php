                ...
                <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu">
                        <li class="submenu-item">
                            <a href="#" id="resetAssesmentButtonhref">Reset Assessment and Enrollment</a>
                        </li>
                        <li class="submenu-item">
                            <a href="<?php echo base_url(); ?>index.php/ose_api/setpaid_test" target="_blank">Set As Enrolled</a>
                        </li>
                        <li class="submenu-item">
                            <a href="#" data-bs-toggle="modal" data-bs-target="#oldStudentAccountModal">Old Student Account Creation</a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-item">
