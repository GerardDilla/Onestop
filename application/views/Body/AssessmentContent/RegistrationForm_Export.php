...
$student_data = $this->data['student_data'];
$get_TotalCountSubject = $this->data['get_TotalCountSubject'];
$get_labfees = $this->data['get_labfees'];
$get_miscfees = $this->data['get_miscfees'];
$get_otherfees = $this->data['get_otherfees'];
$get_totalcash = $this->data['get_totalcash'];
$get_totalunits = $this->data['get_totalunits'];
                ...
                <tbody>
                    ...
                    <tr class="success" style="font-size: 12px; text-align:left">
                        <td width="40%" style="padding:0px 10px 0px 0px" valign="top">
                            <strong>REFERENCE NUMBER:</strong> <?php echo $student_data[0]['Reference_Number']; ?> <br>
                            <strong>NAME:</strong> <?php echo $student_data[0]['First_Name'] . ' ' . $student_data[0]['Middle_Name'] . ' ' . $student_data[0]['Last_Name']; ?> <br>
                            <strong>ADDRESS:</strong> <?php echo $student_data[0]['Address_No'] . ', ' . $student_data[0]['Address_Street'] . ', ' . $student_data[0]['Address_Subdivision'] . ', ' . $student_data[0]['Address_Barangay'] . ', ' . $student_data[0]['Address_City'] . ', ' . $student_data[0]['Address_Province']; ?> <br>
                        </td>
                        <td width="20%" style="padding:0px 10px 0px 0px" valign="top">
                            <strong>SEMESTER:</strong> <?php echo $student_data[0]['Semester']; ?> <br>
                            <strong>COURSE:</strong> <?php echo $student_data[0]['Course']; ?> <br>
                        </td>
                        <td width="20%" style="padding:0px 10px 0px 0px" valign="top">
                            <strong>SCHOOL YEAR:</strong> <?php echo $student_data[0]['School_Year']; ?> <br>
                            <strong>YEAR LEVEL:</strong> <?php echo $student_data[0]['Year_Level']; ?> <br>
                        </td>
                        <td width="20%" style="padding:0px 10px 0px 0px" valign="top">
                            <strong>SECTION:</strong> <?php //echo $student_data[0]['Section']; 
                                                        ?> <br>
            ...
            <table class="pull-right" style="font-size: 13px; width: 80%; text-align:left">
                <tbody>
                    <tr>
                        ...
                        <td class="feesbox"><?php echo $student_data[0]['tuition_Fee']; ?></td>

                        <td><strong>Initial Payment:</strong></td>
                        <td class="feesbox"><?php echo $student_data[0]['InitialPayment']; ?></td>
                    ...
                    <tr>
                        ...
                        <td class="feesbox"><?php echo $student_data[0]['First_Pay']; ?></td>
                    ...
                    <tr>
                        ...
                        <td class="feesbox"><?php echo $student_data[0]['Second_Pay']; ?></td>

                        <td><strong>Scholar:</strong></td>
                        <td class="feesbox"><?php echo $student_data[0]['Scholarship']; ?></td>
                    </tr>
                    <tr>
                        ...
                        <td class="feesbox"><?php echo $student_data[0]['Third_Pay']; ?></td>
                    ...
                    <tr>
                        ...
                        <td class="feesbox"><?php echo $student_data[0]['tuition_Fee'] + $get_miscfees[0]['Fees_Amount'] + $get_otherfees[0]['Fees_Amount']; ?></td>

                        <td><strong>Fourth:</strong></td>
                        <td class="feesbox"><?php echo $student_data[0]['Fourth_Pay']; ?></td>
